...
{
    IQueryable<TbCustomerSession> QueryNoTracking();
    ...
    Task<string?> GetLastNicknameByTableAndDeviceAsync(int tableId, string deviceFingerprint, CancellationToken ct = default);
