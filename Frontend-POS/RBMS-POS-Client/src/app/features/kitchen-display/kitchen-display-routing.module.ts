...
const routes: Routes = [
  { path: '', redirectTo: 'food', pathMatch: 'full' },
  {
    ...
    data: {
      breadcrumb: 'ครัวอาหาร',
      pageTitle: 'ครัวอาหาร',
      pageIcon: 'cook-chef',
      categoryType: 1,
      permissions: ['kitchen-food.read'],
      updatePermission: 'kitchen-food.update',
    },
  ...
  },
  {
    ...
    component: KitchenDisplayComponent,
    data: {
      breadcrumb: 'บาร์เครื่องดื่ม',
      pageTitle: 'บาร์เครื่องดื่ม',
      pageIcon: 'bartender',
      categoryType: 2,
      permissions: ['kitchen-beverage.read'],
      updatePermission: 'kitchen-beverage.update',
    },
    canActivate: [PermissionGuard],
  },
  {
    ...
    component: KitchenDisplayComponent,
    data: {
      breadcrumb: 'ครัวขนมหวาน',
      pageTitle: 'ครัวขนมหวาน',
      pageIcon: 'pastry-chef',
      categoryType: 3,
      permissions: ['kitchen-dessert.read'],
      updatePermission: 'kitchen-dessert.update',
    },
    canActivate: [PermissionGuard],
  },
];
