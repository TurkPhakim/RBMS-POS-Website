...
## 3.4 การออกแบบการทำงานของระบบ (System Flowchart)
...
### 3.4.1 แผนภาพการทำงานส่วนการเข้าสู่ระบบและตรวจสอบสิทธิ์
...
### 3.4.2 แผนภาพการทำงานส่วนการจัดการเมนูอาหาร
...
### 3.4.3 แผนภาพการทำงานส่วนการสั่งอาหารผ่าน QR Code (Self-Order)
...
### 3.4.4 แผนภาพการทำงานส่วนการสร้าง Order โดยพนักงาน
...
### 3.4.5 แผนภาพการทำงานส่วน Kitchen Display และ State Machine
...
### 3.4.6 แผนภาพการทำงานส่วนการปิดบิลและ Split Bill
...
### 3.4.7 แผนภาพการทำงานส่วนการชำระเงินและ OCR Slip Verification
...
### 3.4.8 แผนภาพการทำงานส่วนการจัดการสถานะโต๊ะ
...
### 3.4.9 แผนภาพการทำงานส่วน Permission Matrix
...
### 3.4.10 แผนภาพการทำงานส่วนแจ้งเตือน Real-time ผ่าน SignalR
...
## 3.5 การออกแบบฐานข้อมูล (Data Dictionary)
...
### 3.5.0 การกำหนดตัวเลือกที่ตายตัว (ENUMS)
...
### 3.5.1 ตาราง TbUser (ข้อมูลผู้ใช้งาน)
...
### 3.5.2 ตาราง TbPosition (ตำแหน่งงาน)
...
### 3.5.3 ตาราง TbPermissionMatrix (สิทธิ์การเข้าถึง)
...
### 3.5.4 ตาราง TbEmployee (ข้อมูลพนักงาน)
...
### 3.5.5 ตาราง TbMenu (ข้อมูลเมนูอาหาร)
...
### 3.5.6 ตาราง TbZone และ TbTable (โซนและโต๊ะ)
...
### 3.5.7 ตาราง TbOrder (ข้อมูลออเดอร์)
...
### 3.5.8 ตาราง TbOrderItem (รายการอาหารใน Order)
...
### 3.5.9 ตาราง TbOrderBill และ TbPayment (บิลและการชำระเงิน)
...
### 3.5.10 ตาราง TbCashierSession (Session ลิ้นชักเงินสด)
...
## 3.6 แผนภาพความสัมพันธ์ของเอนทิตี (Entity-Relationship Diagram)
...
### 3.6.1 ER Diagram ส่วน Authentication และ Authorization
...
### 3.6.2 ER Diagram ส่วน Menu Management
...
### 3.6.3 ER Diagram ส่วน Order และ Payment
...
### 3.6.4 ER Diagram ส่วน Table Management
...
### 3.6.5 ER Diagram ส่วน Notification
...
### 3.6.6 คำอธิบายความสัมพันธ์ของระบบฐานข้อมูล
