...
- ดูรูปแบบใน [doc/tasks/README.md](doc/tasks/README.md)
...
│   ├── POS.Main.Business.Authorization/ # Position + Permission Matrix (RBAC)
...
│   ├── POS.Main.Dal/                 # 37 Entities, DbContext, 53 Migrations
│   └── POS.Main.Core/                # Enums, Constants, Exceptions, Helpers, Settings
│
...
**Business Modules ปัจจุบัน (8 modules):**
```
POS.Main.Business.Admin          → Auth, JWT, ServiceCharge, ShopSettings, File, S3, User, Cashier, Dashboard, Email, ReCaptcha
POS.Main.Business.Authorization  → Position, Permission Matrix
POS.Main.Business.HumanResource  → Employee + Address + Education + WorkHistory
POS.Main.Business.Menu           → Menu, MenuSubCategory, Option Group
POS.Main.Business.Notification   → Notification + SignalR Delivery
POS.Main.Business.Order          → Order, OrderBill, Kitchen, Customer (Self-Order), QrRedirect
POS.Main.Business.Payment        → Payment, Receipt, Slip OCR
POS.Main.Business.Table          → Zone, Table, FloorObject, Reservation, TableLink
```
...
| Development Roadmap | [doc/tasks/TASK-development-roadmap.md](doc/tasks/TASK-development-roadmap.md) |
