...
Component จะ **fetch ไฟล์ SVG** จาก `images/icons/{name}.svg` แบบ lazy-load แล้ว cache ไว้ใน static Map (ไม่โหลดซ้ำ)
...
public/images/icons/               ← SVG ไฟล์ทั้งหมด (34+ ไฟล์)
```
...
1. วางไฟล์ `.svg` ใน `public/images/icons/`
