...
export class ServiceChargesService extends BaseService {
   ...
   */
  serviceChargesGetAllGet$Response(params?: ServiceChargesGetAllGet$Params, context?: HttpContext): Observable<StrictHttpResponse<ServiceChargeResponseModelListResponseModel>> {
   ...
   * This method doesn't expect any request body.
   */
  serviceChargesGetAllGet(params?: ServiceChargesGetAllGet$Params, context?: HttpContext): Observable<ServiceChargeResponseModelListResponseModel> {
