...
**Indexes:** `IX_ServiceCharges_IsActive`, `IX_ServiceCharges_DeleteFlag`, `IX_ServiceCharges_Name`
...
| GET    | `/dropdown`          | ดึง Service Charge ที่ Active สำหรับ Dropdown | —                                       | `ListResponseModel<ServiceChargeDropdownModel>` |
...
| DELETE | `/{serviceChargeId}` | ลบ Service Charge (Soft delete)               | URL param                               | `BaseResponseModel<object>`                     |
...
> **หมายเหตุ**: การอัพโหลดไฟล์ทำผ่าน Menus Controller และ HumanResource Controller (ไม่มี endpoint อัพโหลดแยก)
