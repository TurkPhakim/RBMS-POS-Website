...
3. **Layer 3 — ส่วนประมวลผล (Backend)** พัฒนาด้วย ASP.NET Core 9.0 (ทำงานที่พอร์ต 5300) ในรูปแบบสถาปัตยกรรมแบบหลายชั้น ที่ประกอบด้วยโมดูลย่อย 7 ส่วน ได้แก่ ส่วน REST API ที่มี 23 Controllers และจุดบริการ (Endpoint) จำนวนประมาณ 215 จุดบริการ ส่วน SignalR Hubs ที่ประกอบด้วย OrderHub และ NotificationHub สำหรับการสื่อสารแบบเวลาจริง ส่วน Business Logic ที่ประกอบด้วยโมดูลธุรกิจจำนวน 8 โมดูล ส่วน JWT Auth + RBAC ที่จัดการการยืนยันตัวตนและการตรวจสอบสิทธิ์การเข้าถึงตามตำแหน่งงาน ส่วน Slip OCR ที่ทำหน้าที่อ่านคิวอาร์โค้ดและตรวจสอบยอดเงินจากสลิปโอน ส่วน Background Jobs ที่ทำงานเบื้องหลังเพื่อทำความสะอาดข้อมูลอัตโนมัติ (Auto-Cleanup) และส่งการแจ้งเตือนการจองโต๊ะ (Reservation Reminder) และส่วน Email Service ที่ใช้ไลบรารี MailKit ในการส่งอีเมลรหัสครั้งเดียว (One-Time Password: OTP) สำหรับลืมรหัสผ่าน
...
- ระบบต้องสามารถจัดการตำแหน่งงานและกำหนดสิทธิ์การเข้าถึงผ่าน Permission Matrix แบบไดนามิก
- ระบบต้องสามารถจัดการข้อมูลพนักงาน พร้อมข้อมูลที่อยู่ การศึกษา และประวัติการทำงาน
- ระบบต้องสามารถจัดการโต๊ะและผังร้านแบบ Drag-and-Drop พร้อมระบุวัตถุภายในร้าน
- ระบบต้องสามารถตั้งค่า Service Charge และข้อมูลร้าน
- ระบบต้องสามารถเรียกดู Dashboard และรายงานยอดขาย

#### 2) ส่วนของพนักงาน (Staff)

- ระบบต้องรองรับการเข้าสู่ระบบและตรวจสอบสิทธิ์ตามตำแหน่งงาน
- ระบบต้องสามารถเปิด-ปิด Cashier Session พร้อมระบุยอดเงินสดเริ่มต้นและสิ้นกะ
- ระบบต้องสามารถรับชำระเงินทั้งเงินสด (Cash) และการโอนผ่าน QR Code
- ระบบต้องสามารถตรวจสอบสลิปโอนผ่านระบบ OCR และเปรียบเทียบกับยอดที่ต้องชำระ
- ระบบต้องรองรับการแยกบิล (Split Bill) และการรวมบิลก่อนการชำระเงิน
- ระบบต้องแสดง Kitchen Display แบบ Real-time ผ่าน SignalR
- ระบบต้องสามารถเปลี่ยนสถานะ OrderItem ตาม State Machine ที่กำหนด
- ระบบต้องรองรับการรับ Order ที่โต๊ะ การเปลี่ยนสถานะโต๊ะ การจองโต๊ะ และการผูกโต๊ะ

#### 3) ส่วนของลูกค้า (Customer Self-Order)

- ระบบต้องรองรับการสแกน QR Code ที่โต๊ะ พร้อม Token ที่มีอายุการใช้งาน 12 ชั่วโมง
- ระบบต้องป้องกันการสั่งซ้ำซ้อนจากหลายอุปกรณ์ผ่าน Bill Claim Token
- ระบบต้องแสดงเมนูพร้อมรูปภาพ ราคา และตัวเลือกเสริม
- ระบบต้องรองรับการขอเรียกพนักงานและขอชำระเงิน
- ระบบต้องแสดงสถานะอาหารแบบ Real-time

#### 4) ระบบแจ้งเตือนแบบ Real-time (Notification)
...
- ระบบต้องจัดเก็บประวัติการแจ้งเตือนไว้ในฐานข้อมูล
